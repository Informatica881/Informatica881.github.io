		...
		<div class="wp-block-column is-vertically-aligned-stretch" style="padding-right:0;flex-basis:60%">
			...
			<div class="wp-block-group" style="min-height:100%">
				...
				<figure class="wp-block-image size-large is-style-rounded">
					<img src="https://sistemiereti.eu/wp-content/themes/twentytwentyfour/patterns/<br />_<b>Fatal error</b>:  Uncaught Error: Call to undefined function esc_url() in /var/www/html/wp-content/themes/twentytwentyfour/patterns/gallery-project-layout.php:21_Stack trace:_#0 {main}_  thrown in <b>/var/www/html/wp-content/themes/twentytwentyfour/patterns/gallery-project-layout.php</b> on line <b>21</b><br />"></figure>
</div>
</div>
</div>
</div>