...
<div class="wp-block-group alignfull has-base-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column" style="flex-basis:40%">
			<!-- wp:paragraph -->
			<p><br>
<b>Fatal error</b>:  Uncaught Error: Call to undefined function esc_html_x() in /var/www/html/wp-content/themes/twentytwentyfour/patterns/text-project-details.php:18
Stack trace:
#0 {main}
  thrown in <b>/var/www/html/wp-content/themes/twentytwentyfour/patterns/text-project-details.php</b> on line <b>18</b><br>
</p>
</div>
</div>
</div>